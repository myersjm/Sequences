...
def run_test_count_items_bigger_than():
    ...
    # Test 9:
    sequence = [30, 45, 84, 32, 70, -10, -2, 40]
    threshold = 30
    expected = 5
    actual = count_items_bigger_than(sequence, threshold)
    print()
    ...
    # Test 10:
    sequence = [34, 35, 23, 13, 1, 0, -3, 3, 33, -33]
    threshold = -3
    expected = 8
    actual = count_items_bigger_than(sequence, threshold)
    print()
...
def run_test_count_positive_sines():
    ...
    # Test 11:
    expected = 1
    actual = count_positive_sines([0, 2, 6])
    print()
